...
void ncurses::curs_set(int option) { 
    ::curs_set(option); 
}
...
void ncurses::drawBox(ncurses::window_t *win) { 
    box(win, 0, 0); 
}
...
void ncurses::refresh(ncurses::window_t *win) { 
    wrefresh(win); 
}
...
void ncurses::destroyWindow(ncurses::window_t *win) { 
    ::delwin(win); 
}
